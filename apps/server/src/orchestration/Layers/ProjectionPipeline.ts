...
import { makeThreadRuntimeProjection } from "./ProjectionPipeline.projectors.misc.ts";
import { makeThreadProviderItemsProjection } from "./ProjectionPipeline.projectors.threads.ts";
...
const makeOrchestrationProjectionPipeline = Effect.gen(function* () {
  ...
  const applyThreadRuntimeProjection = makeThreadRuntimeProjection(
    projectionThreadRuntimeRepository,
  );
  const applyThreadProviderItemsProjection = makeThreadProviderItemsProjection(
